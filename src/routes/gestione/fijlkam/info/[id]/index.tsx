...
export default component$(() => {
    ...
    return (
        <div class="space-y-10">
            <header>
                <h2 class="text-3xl font-black text-gray-900 dark:text-white tracking-tight">Modifica Informazione</h2>
                <p class="text-gray-500 dark:text-gray-400 font-medium mt-1">Stai modificando: <span class="text-blue-600 font-black">{item.value.title}</span></p>
            </header>
            <FijlkamForm item={item.value} isNew={false} type="info" />
        </div>
    );
});
